...
class _ProxySettingsPageState extends State<ProxySettingsPage> {
  ...
  void initState() {
    ...
    _customProxy = "";
    LocalStorage().getUseFreeProxy().then((value) {
      setState(() {
        _cachedGetUseFreeProxy = value;
      });
    });
    LocalStorage().getActualCustomProxy().then((value) {
      setState(() {
        _customProxy = value;
      });
    });
    _flibustaHostAddress = _httpClient.getFlibustaHostAddress();
    LocalStorage().getFlibustaHostAddress().then((value) {
      setState(() {
        ...
        children: <Widget> [
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                // Container(
                //   padding: EdgeInsets.symmetric(vertical: 16.0, horizontal: 16.0), // TODO: integrate other mirros
                ...
                //       LocalStorage().setFlibustaHostAddress(_flibustaHostAddress);
              ...
              children: <Widget>[
                ...
                RadioListTile(
                  ...
                  onChanged: _cachedGetUseFreeProxy ?? true ? null : ((proxy) {
                    setState(() {
                      _customProxy = proxy;
                      LocalStorage().setActualCustomProxy(_customProxy);
                ...
                Divider(height: 1,),
                FutureBuilder(
                  future: LocalStorage().getUserProxies(),
                  builder: (context, snapshot) {
                          ...
                          List<Widget>.generate(
                            ...
                            RadioListTile(
                              ...
                              secondary: IconButton(
                                ...
                                onPressed: () async {
                                  await LocalStorage().deleteUserProxy(snapshot.data[index]);  
                                  setState(() {});
                                },
                              ),
                            ),
                ...
                ListTile(
                  ...
                  onTap: _cachedGetUseFreeProxy ?? true ? null : () async {
                    ...
                    if (userProxy != null && userProxy.isNotEmpty) {
                      ...
                      LocalStorage().addUserProxy(userProxy);
                    }
                  },
                ),
              ],
