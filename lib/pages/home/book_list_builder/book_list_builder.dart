...
class BookListBuilder extends StatefulWidget {
  ...
  const BookListBuilder({Key key, this.data, this.scaffoldKey})
      : super(key: key);
                  ...
                  Container(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        widget.data[index].authors.isNotEmpty
                            ? ListTile(
                                leading: Tooltip(
                                    message: "Автор(-ы)",
                                    preferBelow: false,
                                ...
                                title: Text(
                                  widget.data[index].authors.toString(),
                                  style: _biggerFont,
                                ),
                              )
                            : Container(),
                        widget.data[index].translators != null &&
                                widget.data[index].translators.isNotEmpty
                            ? ListTile(
                                leading: Tooltip(
                                    message: "Перевод",
                                    preferBelow: false,
                                ...
                                title: Text(
                                  widget.data[index].translators.toString(),
                                  style: _biggerFont,
                                ),
                              )
                            : Container(),
                        widget.data[index].genres != null &&
                                widget.data[index].genres.isNotEmpty
                            ? ListTile(
                                leading: Tooltip(
                                    message: "Жанр произведения",
                                    preferBelow: false,
                            ...
                            : Container(),
                        widget.data[index].sequenceId != null
                            ? ListTile(
                                leading: Tooltip(
                                    message: "Из серии произведений",
                                    preferBelow: false,
                                    child: Icon(Icons.collections_bookmark)),
                                title: Text(
                                  widget.data[index].sequenceTitle,
                                  style: _biggerFont,
                                ),
                              )
                            : Container(),
