...
class _AuthorPageState extends State<AuthorPage> {
  ...
  DsError _dsError;
  SortAuthorBooksBy _sortBooksBy;
      ...
      appBar: DsAppBar(
        ...
        actions: <Widget>[
          PopupMenuButton<SortAuthorBooksBy>(
            ...
            itemBuilder: (context) {
              List<PopupMenuEntry<SortAuthorBooksBy>> entries =
                  SortAuthorBooksBy.values.map((sortBooksBy) {
                return PopupMenuItem<SortAuthorBooksBy>(
                  child: ListTile(
                    title: Text(
                      sortAuthorBooksByToString(sortBooksBy),
                    ),
  ...
  Future<void> _getAuthorInfo() async {
    ...
    try {
      var queryParams = {
        'lang': '__',
        'order': sortAuthorBooksByToQueryParam(_sortBooksBy),
        'hg1': '1',
        'sa1': '1',
        'hr1': '1',
      };
