          ...
          child: Column(
            ...
            children: <Widget>[
              Container(
                ...
                child: Text(
                  """
Если Ваш интернет-провайдер заблокировал интернет-ресурс 'flibusta.is', то Вы можете воспользоваться сервисом PubProxy API на странице 'Настройки прокси' без ограничений на количество запросов. Добавляйте прокси-сервера, пока не найдёте оптимальный для Вас вариант. Чем меньше пинг - тем лучше!
                  """,
...
Во внутреннюю память телефона в папку 'Flibusta'. Там рядом будут папки других приложений, например, Instagram, Telegram, DCIM, Download.
3. Как насчёт добавить ...?
Разработка требует времени, но постараюсь.
                      """,
                  style: TextStyle(color: Colors.white, fontSize: 16.0),
                  textAlign: TextAlign.justify,
                ),
