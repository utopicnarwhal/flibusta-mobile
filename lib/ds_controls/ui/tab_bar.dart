...
class DsTabBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  @override
  _DsTabBarState createState() => _DsTabBarState();
}
...
class _DsTabBarState extends State<DsTabBar> {
  ...
  Decoration get _indicator {
    ...
    return DsUnderlineTabIndicator(
  ...
  @override
  void didUpdateWidget(DsTabBar oldWidget) {
...
class DsUnderlineTabIndicator extends Decoration {
  /// Create an underline style selected tab indicator.
  ///
  /// The [borderSide] and [insets] arguments must not be null.
  const DsUnderlineTabIndicator({
  ...
  Decoration lerpFrom(Decoration a, double t) {
    if (a is DsUnderlineTabIndicator) {
      return DsUnderlineTabIndicator(
  ...
  Decoration lerpTo(Decoration b, double t) {
    if (b is DsUnderlineTabIndicator) {
      return DsUnderlineTabIndicator(
...
class _UnderlinePainter extends BoxPainter {
  ...
  final DsUnderlineTabIndicator decoration;
  ...
  void paint(Canvas canvas, Offset offset, ImageConfiguration configuration) {
    ...
    final Rect indicator = _indicatorRectFor(rect, textDirection).deflate(borderSide.width).translate(0, -6);
    final Paint paint = borderSide.toPaint()..strokeCap = StrokeCap.square;
    // canvas.drawLine(indicator.bottomLeft, indicator.bottomRight, paint);
    final RRect rRectIndicator = RRect.fromRectAndRadius(indicator, Radius.circular(10));
    canvas.drawRRect(rRectIndicator, paint);
  }
}
